document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".p-o-navigation-list");
  const headerRef = document.querySelector(".p-o-header");
  const navigationRef = document.querySelector(".p-o-navigation");
  ...
  document.querySelectorAll(".p-o-navigation-link").forEach((n) =>
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".p-o-toggle-button img");
